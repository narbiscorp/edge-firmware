/*******************************************************************************
 * Smart Glasses Firmware v4.14.2
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.2"
static const char *TAG = "SG_v4.14.2";
...
static void led_task(void *param) {
     ...
     * User sees the number of pulses = current program number. Boot default
     * is PROG_BREATHE (program 0 → 1 pulse). Test builds default to
     * LED_MODE_PULSE_ON_BEAT which isn't a hall program — they get 1 pulse
     * (by convention, indicator maps current_program + 1 → pulses). */
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.2 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.2 started @ %d Hz (GPIO%d)",
