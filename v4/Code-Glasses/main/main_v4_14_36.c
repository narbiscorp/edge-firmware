/*******************************************************************************
 * Smart Glasses Firmware v4.14.36
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.36"
static const char *TAG = "SG_v4.14.36";
...
static uint32_t ppg_jitter_ticks_over = 0;  /* v4.14.36: ticks >25ms late in current window */
/* v4.14.36: boot time marker used by 0xF3 health packet to compute uptime. */
static uint32_t ppg_boot_ms = 0;
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.36 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.36 started @ %d Hz (GPIO%d)",
