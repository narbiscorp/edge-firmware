/*******************************************************************************
 * Smart Glasses Firmware v4.14.13
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.13"
static const char *TAG = "SG_v4.14.13";
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.13 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.13 started @ %d Hz (GPIO%d)",
