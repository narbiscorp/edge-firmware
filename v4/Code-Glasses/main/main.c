/*******************************************************************************
 * Smart Glasses Firmware v4.14.1
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.1"
static const char *TAG = "SG_v4.14.1";
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.1 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.1 started @ %d Hz (GPIO%d)",
