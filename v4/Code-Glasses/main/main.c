 ...
 * tick. v4.8 uses esp_timer (hardware timer, 1µs resolution from 40MHz XTAL)
 ...
 * 
 * CHANGELOG v4.8:
 * - Replaced vTaskDelay strobe with esp_timer (1µs precision)
 * - Added AB command: set strobe frequency 1-40Hz via BLE
 * - Default strobe frequency: 10Hz
 * - led_task simplified to session management only
 ******************************************************************************/
