/*******************************************************************************
 * Smart Glasses Firmware v4.14.4
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.4"
static const char *TAG = "SG_v4.14.4";
...
static int indicator_tick(void) {
    ...
    int duty = (int)(frac * (float)INDICATOR_PEAK_PCT * 2.55f);  /* % → 0-255 */
    if (duty < 0) duty = 0;
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.4 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.4 started @ %d Hz (GPIO%d)",
