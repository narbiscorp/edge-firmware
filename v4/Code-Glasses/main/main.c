/*******************************************************************************
 * Smart Glasses Firmware v4.14.34
 *
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.14.34"
static const char *TAG = "SG_v4.14.34";
...
/* Forward declarations — actual variables are defined further down
 * in their respective modules. prefs_load() is called from app_main
 * after nvs_flash_init, before tasks start. */
extern volatile uint8_t  brightness;
extern volatile uint32_t session_duration_ms;
extern volatile uint16_t strobe_dhz;
extern volatile uint8_t  strobe_duty_pct;
extern volatile uint8_t  breathe_bpm;
extern volatile uint8_t  breathe_inhale_pct;
extern volatile uint8_t  breathe_hold_top;
extern volatile uint8_t  breathe_hold_bot;
extern volatile uint8_t  breathe_wave;
...
static void coherence_task(void *arg) {
    ESP_LOGI(TAG, "Coherence task v4.14.34 started (Fs=%.1fHz, N=%d, window=%.0fs)",
...
static void ppg_task(void *arg) {
    ...
    ESP_LOGI(TAG, "PPG task v4.14.34 started @ %d Hz (GPIO%d)",
