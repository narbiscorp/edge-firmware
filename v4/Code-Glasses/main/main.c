 ...
 * analog source driving a voltage into it. 11dB attenuation gives a
 * usable input range of roughly 0-3.1V (matches the .ino's ADC_11db).
 * 12-bit width gives 0-4095 raw counts (matches .ino's
...
static void pulse_adc_init(void) {
    ...
    adc_oneshot_chan_cfg_t chan_cfg = {
        ...
        .atten = ADC_ATTEN_DB_12,   /* ~0-3.1V range (a.k.a. "11dB" in Arduino nomenclature) */
    };
