 ...
 * 
 * CHANGELOG v4.9.2:
 * - Added LED mode system: STROBE / STATIC / BREATHE
 * - Strobe: asymmetric duty cycle via one-shot esp_timer (AC command)
 * - Breathing engine: cosf sine/linear, BPM, ratio, holds (B0-B5)
 * - Keeps: deferred OTA, OTA write drain, deci-Hz, esp_timer strobe
 ******************************************************************************/
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.9.2"
static const char *TAG = "SG_v4.9.2";
