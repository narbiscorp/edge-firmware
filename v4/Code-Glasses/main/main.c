 ...
 * 
 * CHANGELOG v4.9.3:
 * - Page-based CRC OTA: buffer 4KB pages in RAM, CRC32 verify, then flash
 * - New status codes: 0x06 (page CRC), 0x07 (page OK), 0x08 (page resend)
 * - New command: 0xAD (page confirm/reject)
 * - Enables fast WriteWithoutResponse transfer with per-page integrity
 * - Keeps: all v4.9.2 mode/strobe/breathe/OTA infrastructure
 ******************************************************************************/
 ...
 ******************************************************************************/
#define FIRMWARE_VERSION "4.9.3"
static const char *TAG = "SG_v4.9.3";
...
/* Page buffer size — must match web app PAGE_SIZE */
